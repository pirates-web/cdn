            ...
            1936: function () {
                !function (e) {
                    ...
                    function l(t, o) {
                        ...
                        })), a = 0, c = r.length; a < c; a++) if (l.match(r[a])) return !0;
                        return !1
                    }

                    function r(e, t, i) {
                        if (i && "function" == typeof i) return i(e);
                        for (var s = Object.keys(t), n = 0, o = e.length; n < o; n++) for (var r = e[n].querySelectorAll("*"), a = 0, c = r.length; a < c; a++) {
                            var d = r[a], h = d.nodeName.toLowerCase();
                            if (-1 !== s.indexOf(h)) for (var p = [].slice.call(d.attributes), u = [].concat(t["*"] || [], t[h] || []), f = 0, m = p.length; f < m; f++) {
                                var v = p[f];
                    ...
                    "classList" in document.createElement("_") || function (t) {
                        if ("Element" in t) {
                            var i = "classList", s = "prototype", n = t.Element[s], o = Object, l = function () {
                                var t = e(this);
                                return {
                                    add: function (e) {
                    ...
                    if (h.classList.add("c1", "c2"), !h.classList.contains("c2")) {
                        var p = DOMTokenList.prototype.add, u = DOMTokenList.prototype.remove;
                    ...
                    h = null, Object.values = "function" == typeof Object.values ? Object.values : function (e) {
                        ...
                        var i = t.length, s = String(e), n = s.length, o = arguments.length > 1 ? arguments[1] : void 0,
                            l = o ? Number(o) : 0;
                        l != l && (l = 0);
                    ...
                    e.fn.triggerNative = function (e) {
                        var t, i = this[0];
                        i.dispatchEvent && (w ? t = new Event(e, {bubbles: !0}) : (t = document.createEvent("Event")).initEvent(e, !0, !1), i.dispatchEvent(t))
                    };
                    var y = {
                            "À": "A",
                            "Á": "A",
                    ...
                    }, R = {MENU: "." + B.MENU, DATA_TOGGLE: 'data-toggle="dropdown"'}, j = {
                    ...
                    var U = new RegExp("38|40"), V = new RegExp("^9$|27"), _ = {
                        li: function (e, t, i) {
                            ...
                            if (!0 === t) for (; n.childNodes.length > 0;) j.fragment.appendChild(n.childNodes[0]); else j.fragment.appendChild(n);
                            return j.fragment
                        }, label: function (e) {
                    ...
                    function Q(i) {
                        ...
                        var c = this.each((function () {
                            var i = e(this);
                            if (i.is("select")) {
                                var l = i.data("selectpicker"), r = "object" == typeof o && o;
                                if (r.title && (r.placeholder = r.title), l) {
                                    if (r) for (var c in r) Object.prototype.hasOwnProperty.call(r, c) && (l.options[c] = r[c])
                                } else {
                                    var d = i.data();
                    ...
                    K.VERSION = "1.14.0-beta3", K.DEFAULTS = {
                        ...
                        constructor: K, init: function () {
                            var t = this, i = this.$element.attr("id"), s = this.$element[0], n = s.form;
                            ...
                            var t = this.multiple || this.options.showTick ? " show-tick" : "",
                                i = this.multiple ? ' aria-multiselectable="true"' : "", s = "",
                            ...
                            var n = this, o = 0;
                            if (this.selectpicker.isSearching = t, this.selectpicker.current = t ? this.selectpicker.search : this.selectpicker.main, this.setPositionData(), i) if (s) o = this.$menuInner[0].scrollTop; else if (!n.multiple) {
                                var l = n.$element[0], a = (l.options[l.selectedIndex] || {}).liIndex;
                                if ("number" == typeof a && !1 !== n.options.size) {
                                    var c = n.selectpicker.main.data[a], d = c && c.position;
                                    d && (o = d - (n.sizeInfo.menuInnerHeight + n.sizeInfo.liHeight) / 2)
                                }
                            }

                            function h(e, i) {
                                var s, o, l, a, c, d, p, u, f, m, v = n.selectpicker.current.data.length, g = [],
                                    b = !0, w = n.isVirtual();
                                ...
                                if (void 0 === c && (c = 0), d = [n.selectpicker.view.position0, n.selectpicker.view.position1], l = Math.max(0, c - 1), a = Math.min(o - 1, c + 1), n.selectpicker.view.position0 = !1 === w ? 0 : Math.max(0, g[l][0]) || 0, n.selectpicker.view.position1 = !1 === w ? v : Math.min(v, g[a][1]) || 0, p = d[0] !== n.selectpicker.view.position0 || d[1] !== n.selectpicker.view.position1, void 0 !== n.activeElement && (i && (n.activeElement !== n.selectedElement && n.defocusItem(n.activeElement), n.activeElement = void 0), n.activeElement !== n.selectedElement && n.defocusItem(n.selectedElement)), void 0 !== n.prevActiveElement && n.prevActiveElement !== n.activeElement && n.prevActiveElement !== n.selectedElement && n.defocusItem(n.prevActiveElement), i || p || n.selectpicker.current.hasMore) {
                                    if (u = n.selectpicker.view.visibleElements ? n.selectpicker.view.visibleElements.slice() : [], n.selectpicker.view.visibleElements = !1 === w ? n.selectpicker.current.elements : n.selectpicker.current.elements.slice(n.selectpicker.view.position0, n.selectpicker.view.position1), n.setOptionStatus(), (t || !1 === w && i) && (f = u, m = n.selectpicker.view.visibleElements, b = !(f.length === m.length && f.every((function (e, t) {
                                        ...
                                        var y, x, E = n.$menuInner[0], $ = document.createDocumentFragment(),
                                            S = E.firstChild.cloneNode(!1), C = n.selectpicker.view.visibleElements,
                                            O = [];
                                        ...
                                        if (n.options.sanitize && O.length && r(O, n.options.whiteList, n.options.sanitizeFn), !0 === w ? (y = 0 === n.selectpicker.view.position0 ? 0 : n.selectpicker.current.data[n.selectpicker.view.position0 - 1].position, x = n.selectpicker.view.position1 > v - 1 ? 0 : n.selectpicker.current.data[v - 1].position - n.selectpicker.current.data[n.selectpicker.view.position1 - 1].position, E.firstChild.style.marginTop = y + "px", E.firstChild.style.marginBottom = x + "px") : (E.firstChild.style.marginTop = 0, E.firstChild.style.marginBottom = 0), E.firstChild.appendChild($), !0 === w && n.sizeInfo.hasScrollBar) {
                                            ...
                                            if (i && L < n.sizeInfo.menuInnerInnerWidth && n.sizeInfo.totalMenuWidth > n.sizeInfo.selectWidth) E.firstChild.style.minWidth = n.sizeInfo.menuInnerInnerWidth + "px"; else if (L > n.sizeInfo.menuInnerInnerWidth) {
                            ...
                            if ((this.options.placeholder || this.options.allowClear) && !this.multiple) {
                                ...
                                var i = this.$element[0], s = !1, n = !this.selectpicker.view.titleOption.parentNode,
                                    o = i.selectedIndex, l = i.options[o],
                                    r = i.querySelector("select > *:not(:disabled)"), a = r ? r.index : 0,
                            ...
                            var s = this, n = !1 === t ? F.fromOption : F.fromDataSource,
                                o = ':not([hidden]):not([data-hidden="true"]):not([style*="display: none"])', l = [],
                                r = this.selectpicker.main.data ? this.selectpicker.main.data.length : 0, a = 0,
                            ...
                            function p(i, o) {
                                if ((o = o || {}).divider = n(i, "divider"), !0 === o.divider) h({optID: o.optID}); else {
                                    var a = l.length + r, c = n(i, "style"), d = c ? D(c) : "",
                            ...
                            function u(e, i) {
                                var s = i[e], r = !(e - 1 < c) && i[e - 1], d = i[e + 1],
                            ...
                            var i = this, s = t ? this.selectpicker.search.data : this.selectpicker.main.data, n = [],
                                o = 0;
                            ...
                            var t, i, s = this, n = this.$element[0],
                                o = this.setPlaceholder() && 0 === n.selectedIndex, l = m.call(this), a = l.length,
                                c = v.call(this, l), d = this.$button[0],
                                h = d.querySelector(".filter-option-inner-inner"),
                                p = document.createTextNode(this.options.multipleSeparator),
                                u = j.fragment.cloneNode(!1), f = !1;
                            if (this.options.source.data && e && (l.map((function e(t) {
                            ...
                            })), n.appendChild(this.selectpicker.main.optionQueue), o && (o = 0 === n.selectedIndex)), d.classList.toggle("bs-placeholder", s.multiple ? !a : !c && 0 !== c), s.multiple || 1 !== l.length || (s.selectpicker.view.displayedValue = c), "static" === this.options.selectedTextFormat) u = _.text.call(this, {text: this.options.placeholder}, !0); else if ((t = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && a > 0) && (t = (i = this.options.selectedTextFormat.split(">")).length > 1 && a > i[1] || 1 === i.length && a >= 2), !1 === t) {
                                if (!o) {
                                ...
                                u = _.text.call(this, {text: y.replace("{0}", a.toString()).replace("{1}", I.toString())}, !0)
                            }
                            if (u.childNodes.length || (u = _.text.call(this, {text: this.options.placeholder ? this.options.placeholder : this.options.noneSelectedText}, !0)), d.title = u.textContent.replace(/<[^>]*>?/g, "").trim(), this.options.sanitize && f && r([u], s.options.whiteList, s.options.sanitizeFn), h.innerHTML = "", h.appendChild(u), M.major < 4 && this.$newElement[0].classList.contains("bs3-has-addon")) {
                                var x = d.querySelector(".filter-expand"), E = h.cloneNode(!0);
                            ...
                            if (t || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                                var i, s = j.div.cloneNode(!1), n = j.div.cloneNode(!1), o = j.div.cloneNode(!1),
                                    l = document.createElement("ul"), r = j.li.cloneNode(!1), a = j.li.cloneNode(!1),
                                ...
                                var w, k = i.offsetHeight, y = a ? a.offsetHeight : 0, x = h ? h.offsetHeight : 0,
                                    E = p ? p.offsetHeight : 0, $ = u ? u.offsetHeight : 0, S = f ? f.offsetHeight : 0,
                                    C = e(r).outerHeight(!0), O = window.getComputedStyle(n), A = n.offsetWidth, T = {
                            ...
                            var t, i, s, n, o, l, r, a, c = this.sizeInfo.selectWidth, d = this.sizeInfo.liHeight,
                                h = this.sizeInfo.headerHeight, p = this.sizeInfo.searchHeight,
                                u = this.sizeInfo.actionsHeight, f = this.sizeInfo.doneButtonHeight,
                                m = this.sizeInfo.dividerHeight, v = this.sizeInfo.menuPadding, g = 0;
                            ...
                            var i, s, n = e.element, o = void 0 !== this.activeElement,
                            ...
                            i.data("spaceSelect", !1), this.$button.on("keyup", (function (e) {
                                ...
                                if (t.options.allowClear) {
                                    var i = e.target, s = t.$clearButton[0];
                                    /MSIE|Trident/.test(window.navigator.userAgent) && (i = document.elementFromPoint(e.clientX, e.clientY)), i !== s && i.parentElement !== s || (e.stopImmediatePropagation(), function (e) {
                                        if (t.multiple) t.deselectAll(); else {
                                            var i = t.$element[0], s = i.value, n = i.selectedIndex, o = i.options[n],
                                ...
                                var i = this.parentElement, s = t.isVirtual() ? t.selectpicker.view.position0 : 0,
                                ...
                                var n = e(this), o = t.$element[0],
                                    l = t.isVirtual() ? t.selectpicker.view.position0 : 0,
                                    r = t.selectpicker.current.data[n.parent().index() + l], a = r.element,
                                    c = v.call(t), d = o.selectedIndex, h = o.options[d],
                                    p = !!h && t.selectpicker.main.data[h.liIndex], u = !0;
                                if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(), i.preventDefault(), !t.isDisabled() && !n.parent().hasClass(B.DISABLED)) {
                                    var f = r.option, g = e(f), w = f.selected,
                                        k = t.selectpicker.current.data.find((function (e) {
                                            return e.optID === r.optID && "optgroup-label" === e.type
                                        })), I = k ? k.optgroup : void 0,
                                        y = I instanceof Element ? F.fromOption : F.fromDataSource, x = I && I.children,
                                        E = parseInt(t.options.maxOptions), $ = I && parseInt(y(I, "maxOptions")) || !1;
                                    if (a === t.activeElement && (s = !0), s || (t.prevActiveElement = t.activeElement, t.activeElement = void 0), t.multiple && 1 !== E) {
                                        if (t.setSelected(r, !w), t.focusedParent.focus(), !1 !== E || !1 !== $) {
                                            var S = E < m.call(t).length, C = 0;
                                            if (I && I.children) for (var O = 0; O < I.children.length; O++) I.children[O].selected && C++;
                                            var A = $ < C;
                                            if (E && S || $ && A) if (E && 1 === E) o.selectedIndex = -1, t.setOptionStatus(!0); else if ($ && 1 === $) {
                                                ...
                                                var z = "string" == typeof t.options.maxOptionsText ? [t.options.maxOptionsText, t.options.maxOptionsText] : t.options.maxOptionsText,
                                                    ...
                                                    L = D[0].replace("{n}", E), N = D[1].replace("{n}", $),
                            ...
                            this.$button.on("click.bs.dropdown.data-api", (function () {
                                ...
                                if (e.selectpicker.search.elements = [], e.selectpicker.search.data = [], t) if (e.selectpicker.search.previousValue = t, e.options.source.search) e.fetchData((function (i) {
                                    e.render(), e.buildList(void 0, !0), e.noScroll = !0, e.$menuInner.scrollTop(0), e.createView(!0), G.call(e, i, t)
                                }), "search", 0, t); else {
                                    var i = [], s = t.toUpperCase(), n = {}, o = [], l = e._searchStyle(),
                            ...
                            if (void 0 !== e) {
                                var i = m.call(this), s = v.call(this, i);
                                ...
                                }), this), this.options.source.data && t.appendChild(this.selectpicker.main.optionQueue), this.$element.trigger("changed" + W, b), this.$newElement.hasClass(B.SHOW)) if (this.multiple) this.setOptionStatus(!0); else {
                            ...
                            if (this.multiple) {
                                void 0 === e && (e = !0);
                                var t = this.$element[0], i = 0, s = 0, n = v.call(this);
                            ...
                            var i, s, n, o, l, r = e(this), a = r.hasClass("dropdown-toggle"),
                                c = (a ? r.closest(".dropdown") : r.closest(R.MENU)).data("this"), d = c.findLis(),
                                h = !1, p = 9 === t.which && !a && !c.options.selectOnTab, u = U.test(t.which) || p,
                                f = c.$menuInner[0].scrollTop,
                                m = !0 === c.isVirtual() ? c.selectpicker.view.position0 : 0;
                            if (!(t.which >= 112 && t.which <= 123)) if (!(s = c.$menu.hasClass(B.SHOW)) && (u || t.which >= 48 && t.which <= 57 || t.which >= 96 && t.which <= 105 || t.which >= 65 && t.which <= 90) && (c.$button.trigger("click.bs.dropdown.data-api"), c.options.liveSearch)) c.$searchbox.trigger("focus"); else {
                                if (27 === t.which && s && (t.preventDefault(), c.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), u) {
                                    if (!d.length) return;
                                    -1 !== (i = (n = c.activeElement) ? Array.prototype.indexOf.call(n.parentElement.children, n) : -1) && c.defocusItem(n), 38 === t.which ? (-1 !== i && i--, i + m < 0 && (i += d.length), c.selectpicker.view.canHighlight[i + m] || -1 == (i = c.selectpicker.view.canHighlight.slice(0, i + m).lastIndexOf(!0) - m) && (i = d.length - 1)) : (40 === t.which || p) && (++i + m >= c.selectpicker.view.canHighlight.length && (i = c.selectpicker.view.firstHighlightIndex), c.selectpicker.view.canHighlight[i + m] || (i = i + 1 + c.selectpicker.view.canHighlight.slice(i + m + 1).indexOf(!0))), t.preventDefault();
                                    var v = m + i;
                            ...
                            var t = this, i = e.extend({}, this.options, a(this.$element), this.$element.data());
